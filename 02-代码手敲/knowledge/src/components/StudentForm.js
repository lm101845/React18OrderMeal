...
const StudentForm = () => {
    ...
    return (
        <tr className="student-form">
            <td><input onChange={nameChangeHandler} value={inputData.name}/></td>
            <td>
            ...
            <td><input onChange={ageChangeHandler} value={inputData.age}/></td>
            <td><input onChange={addressChangeHandler} value={inputData.address}/></td>
